    ...
    xhr.onreadystatechange = function (){
        if(xhr.readyState === 4 && xhr.status === 200){
            var json = JSON.parse(xhr.responseText);
                ...
                pageHTML += "</div>";
            //var myWindow = window.open("https://thegreatestfarmer.000webhostapp.com/view/buyer/showPost.php", "_self");
            var myWindow = window.open("localhost/305fp/view/buyer/showPost.php", "_self");
