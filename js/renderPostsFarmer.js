        ...
        if(xhr.readyState === 4 && xhr.status === 200){
            ...
            for(var data in json['posts']){
                ...
                if(json['posts'][data].title.length > 19){
                    posts.innerHTML += formLearningPostFarmer(json['posts'][data].title.substring(0,19) + "...", contents, json['posts'][data].postid);
                }
                else{
                    posts.innerHTML += formLearningPostFarmer(json['posts'][data].title, contents, json['posts'][data].postid);
                }
            }  
